...
function PreviewSidebar({
  ...
  return (
    <div
      className={`sidebar-container pointer-events-none do-no-capture fixed w-fit p-2 md:p-3 lg:p-4 top-0 left-0 bottom-0 flex items-start z-10 transition-all duration-300 ${!isPlaying ? " bg-violet-500" : ""
        }`}
    >
